...
const OnsaleSlider = () => {
  ...
  const products = [
    {
      imageUrl1: "diamond/image/cache/catalog/product/2/1-1000x1000.png",
      imageUrl2: "diamond/image/cache/catalog/product/2/2-1000x1000.png",
      brand: "bag",
      ...
      link: "diamond/index.php?route=product/product&language=en-gb&product_id=42",
      sizes: ["m", "s"],
    },
    {
      imageUrl1: "diamond/image/cache/catalog/product/11/1-1000x1000.png",
      imageUrl2: "diamond/image/cache/catalog/product/11/2-1000x1000.png",
      brand: "cloths",
      ...
      link: "diamond/index.php?route=product/product&language=en-gb&product_id=30",
      sizes: ["l", "m"],
    },
    {
      imageUrl1: "diamond/image/cache/catalog/product/1/1-1000x1000.png",
      imageUrl2: "diamond/image/cache/catalog/product/1/2-1000x1000.png",
      brand: "shoes",
    ...
    {
      imageUrl1: "diamond/image/cache/catalog/product/13/1-1000x1000.png",
      imageUrl2: "diamond/image/cache/catalog/product/13/2-1000x1000.png",
      brand: "bag",
      name: "golden ring",
      price: "$1.00",
      description:
      ...
      link: "diamond/index.php?route=product/product&language=en-gb&product_id=34",
      sizes: ["xl", "xxl"],
    },
