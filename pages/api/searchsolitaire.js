...
export default async (req, res) => {
  if (req.method === "GET") {
    ...
    try {
      const pageNumber = parseInt(req.body.pageNumber) || 1; // Default to page 1
      const pageSize = parseInt(req.body.pageSize) || 20; // Default to page size 20
      const postjson = req.body.filter || {};
      const result = await callStoredProcedure(
        "sp_GetSolitairesByPage",
        {
          PageNumber: pageNumber,
