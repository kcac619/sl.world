...
const Index = () => {
  ...
  C409.699,390.129,410.355,381.902,407.164,374.717z"
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6 col-xs-12">
                      <div className="wbspecial">
                        <div className="col cless">
                          <form
                            method="post"
                            data-oc-toggle="ajax"
                            data-oc-load="https://opencart.workdo.io/diamond/index.php?route=common/cart|info&language=en-gb"
                            ...
                            <div className="product-thumb">
                              <div className="product-bg">
                                <div className="image">
                                  {/* Save Price start */}
                                  {/*                        
       <span class="you-save">$129.99</span> 
             */}
                                  {/* Save Price end */}
                                  {/* discount % start */}
                                  <span className="discount-onprice">46%</span>
                                  {/* discount % end */}
                                  <a href="https://opencart.workdo.io/diamond/index.php?route=product/product&language=en-gb&product_id=29">
                                    <div className="second-image">
                                      <img
                                        src="https://opencart.workdo.io/diamond/image/cache/catalog/product/10/1-1000x1000.png"
                                        title="Specials"
                                        alt="Specials"
                                        className="img-fluid"
                                      />
                                    ...
                                    <div className="second-image">
                                      <img
                                        src="https://opencart.workdo.io/diamond/image/cache/catalog/product/10/2-1000x1000.png"
                                        title="Specials"
                                        alt="Specials"
                                        className="img-fluid"
                                      />
    ...
    <span class="rate-tot">()</span>
</div>
*/}
                                  {/* discount % start */}
                                  {/*                        <span class="discount-onprice">46%</span>
                                   */}
                                  {/* discount % end */}
                                  <div className="price">
                                    <span className="price-new">$150.00</span>
                                    <div className="wbfullprice">
                                      <span className="price-old">$3.00</span>
                                    </div>
                                  </div>
                                  <p className="catlist-des">
                                    Redefine your workday with the Palm Treo Pro
                                    smartphone. Perfectly balanced, you can
                                    respond to business and personal email, stay
                                    on top of appointments and contacts, and use
                                    Wi-Fi or GPS when you’re ..
                                  </p>
                                  ...
                                  <div className="homeadd d-flex justify-content-between">
    ...
    <button type="button" id="add" class="add btn">+</button>
                                    ...
                                    <button
                                      type="submit"
                                      formAction="https://opencart.workdo.io/diamond/index.php?route=checkout/cart|add&language=en-gb"
                            ...
                            <div className="product-thumb">
                              <div className="product-bg">
                                <div className="image">
                                  {/* Save Price start */}
                                  {/*                        
       <span class="you-save">$-59.00</span> 
             */}
                                  {/* Save Price end */}
                                  {/* discount % start */}
                                  <span className="discount-onprice">-74%</span>
                                  {/* discount % end */}
                                  <a href="https://opencart.workdo.io/diamond/index.php?route=product/product&language=en-gb&product_id=31">
                                    <div className="second-image">
                                      <img
                                        src="https://opencart.workdo.io/diamond/image/cache/catalog/product/12/1-1000x1000.png"
                                        title="Specials"
                                        alt="Specials"
                                        className="img-fluid"
                                      />
                                    ...
                                    <div className="second-image">
                                      <img
                                        src="https://opencart.workdo.io/diamond/image/cache/catalog/product/12/2-1000x1000.png"
                                        title="Specials"
                                        alt="Specials"
                                        className="img-fluid"
                                      />
...
*/}
                                  {/* discount % start */}
                                  {/*                        <span class="discount-onprice">-74%</span>
                                   */}
                                  {/* discount % end */}
                                  <div className="price">
                                    <span className="price-new">$139.00</span>
                                    <div className="wbfullprice">
                                      <span className="price-old">$1.00</span>
                                    </div>
                                  </div>
                                  <p className="catlist-des">
                                    Engineered with pro-level features and
                                    performance, the 12.3-effective-megapixel
                                    D300 combines brand new technologies with
                                    advanced features inherited from Nikon's
                                    newly announced D3 professional digi..
                                  </p>
                                  <div className="web_option">
                                    <div className="mb-3 required">
                                      <label className="form-label">Size</label>
                            ...
                            <div className="product-thumb">
                              <div className="product-bg">
                                <div className="image">
                                  {/* Save Price start */}
                                  {/*                        
       <span class="you-save">$1,862.00</span> 
             */}
                                  {/* Save Price end */}
                                  {/* discount % start */}
                                  <span className="discount-onprice">93%</span>
                                  {/* discount % end */}
                                  <a href="https://opencart.workdo.io/diamond/index.php?route=product/product&language=en-gb&product_id=45">
                                    <div className="second-image">
                                      <img
                                        src="https://opencart.workdo.io/diamond/image/cache/catalog/product/5/1-1000x1000.png"
                                        title="Specials"
                                        alt="Specials"
                                        className="img-fluid"
                                      />
                                    ...
                                    <div className="second-image">
                                      <img
                                        src="https://opencart.workdo.io/diamond/image/cache/catalog/product/5/2-1000x1000.png"
                                        title="Specials"
                                        alt="Specials"
                                        className="img-fluid"
                                      />
                                ...
                                <div className="product-caption">
                                  ...
                                  <h4 className="protitle">
                                    <a href="https://opencart.workdo.io/diamond/index.php?route=product/product&language=en-gb&product_id=45">
                                      round shap design in diamond earrings
                                    </a>
                                  </h4>
                                </div>
                                <div className="caption">
...
*/}
                                  {/* discount % start */}
                                  {/*                        <span class="discount-onprice">93%</span>
                                   */}
                                  {/* discount % end */}
                                  <div className="price">
                                    <span className="price-new">$138.00</span>
                                    <div className="wbfullprice">
                                      <span className="price-old">$1.00</span>
                                    </div>
                                  </div>
                                  <p className="catlist-des">
                                    Latest Intel mobile architecture Powered by
                                    the most advanced mobile processors from
                                    Intel, the new Core 2 Duo MacBook Pro is
                                    over 50% faster than the original Core Duo
                                    MacBook Pro and now supports..
                                  </p>
                                  <div className="web_option">
                                    <div className="mb-3 required">
                                      <label className="form-label">Size</label>
                            ...
                            <div className="product-thumb">
                              <div className="product-bg">
                                <div className="image">
                                  {/* Save Price start */}
                                  {/*                        
       <span class="you-save">$-253.00</span> 
             */}
                                  {/* Save Price end */}
                                  {/* discount % start */}
                                  ...
                                  {/* discount % end */}
                                  <a href="https://opencart.workdo.io/diamond/index.php?route=product/product&language=en-gb&product_id=49">
                                    <div className="second-image">
                                      <img
                                        src="https://opencart.workdo.io/diamond/image/cache/catalog/product/7/1-1000x1000.png"
                                        title="Specials"
                                        alt="Specials"
                                        className="img-fluid"
                                      />
                                    ...
                                    <div className="second-image">
                                      <img
                                        src="https://opencart.workdo.io/diamond/image/cache/catalog/product/7/2-1000x1000.png"
                                        title="Specials"
                                        alt="Specials"
                                        className="img-fluid"
                                      />
                                ...
                                <div className="product-caption">
                                  ...
                                  <h4 className="protitle">
                                    <a href="https://opencart.workdo.io/diamond/index.php?route=product/product&language=en-gb&product_id=49">
                                      simple butterfly design pandal
                                    </a>
                                  </h4>
                                </div>
                                <div className="caption">
...
*/}
                                  {/* discount % start */}
                                  {/*                        <span class="discount-onprice">-127%</span>
                                   */}
                                  {/* discount % end */}
                                  <div className="price">
                                    <span className="price-new">$452.00</span>
                                    <div className="wbfullprice">
                                      <span className="price-old">$1.00</span>
                                    </div>
                                  </div>
                                  <p className="catlist-des">
                                    ...
                                    thinnest tablet, measuring 8.6 mm thickness,
                                    running with Android 3.0 Honeycomb OS on a
                                    1GHz dual-core Tegra 2 processor, similar to
                                    its younger brother Samsung..
                                  </p>
                                  <div className="web_option">
                                    <div className="mb-3 required">
                                      <label className="form-label">Size</label>
                            ...
                            <div className="product-thumb">
                              <div className="product-bg">
                                <div className="image">
                                  ...
                                  {/* discount % start */}
                                  {/* discount % end */}
                                  <a href="https://opencart.workdo.io/diamond/index.php?route=product/product&language=en-gb&product_id=28">
                                    <div className="second-image">
                                      <img
                                        src="https://opencart.workdo.io/diamond/image/cache/catalog/product/1/1-1000x1000.png"
                                        title="<b>Best Dill’s </b> Product stores"
                                        alt="<b>Best Dill’s </b> Product stores"
                                        className="img-fluid"
                                      />
                                    </div>
                                    <div className="second-image">
                                      <img
                                        src="https://opencart.workdo.io/diamond/image/cache/catalog/product/1/2-1000x1000.png"
                                        title="<b>Best Dill’s </b> Product stores"
                                        alt="<b>Best Dill’s </b> Product stores"
                                        className="img-fluid"
                                      />
                                ...
                                <div className="product-caption">
                                  <div className="bran">
                                    <span>
                                      <a
                                        href="https://opencart.workdo.io/diamond/index.php?route=product/manufacturer|info&manufacturer_id=5"
                                        className="textdeb"
                                      >
                                        shoes
                                      </a>
...
*/}
                                  ...
                                  {/* discount % end */}
                                  <div className="price">
                                    <span className="price-new">$1.00</span>
                                  </div>
                                  <p className="catlist-des">
                            ...
                            <div className="product-thumb">
                              <div className="product-bg">
                                <div className="image">
                                  ...
                                  {/* discount % start */}
                                  {/* discount % end */}
                                  <a href="https://opencart.workdo.io/diamond/index.php?route=product/product&language=en-gb&product_id=34">
                                    <div className="second-image">
                                      <img
                                        src="https://opencart.workdo.io/diamond/image/cache/catalog/product/13/1-1000x1000.png"
                                        title="<b>Best Dill’s </b> Product stores"
                                        alt="<b>Best Dill’s </b> Product stores"
                                        className="img-fluid"
                                      />
                                    ...
                                    <div className="second-image">
                                      <img
                                        src="https://opencart.workdo.io/diamond/image/cache/catalog/product/13/2-1000x1000.png"
                                        title="<b>Best Dill’s </b> Product stores"
                                        alt="<b>Best Dill’s </b> Product stores"
                                        className="img-fluid"
                                      />
                                ...
                                <div className="product-caption">
                                  <div className="bran">
                                    <span>
                                      <a
                                        href="https://opencart.workdo.io/diamond/index.php?route=product/manufacturer|info&manufacturer_id=8"
                                        className="textdeb"
                                      >
                                        bag
                                      </a>
...
*/}
                                  ...
                                  <p className="catlist-des">
                                    Born to be worn. Clip on the worlds most
                                    wearable music player and take up to 240
                                    songs with you anywhere. Choose from five
                                    colors including four new hues to make your
                                    musical fashion statement. R..
                                  </p>
                                  <div className="web_option">
                                    <div className="mb-3 required">
                                      <label className="form-label">Size</label>
                            ...
                            <div className="product-thumb">
                              <div className="product-bg">
                                <div className="image">
                                  ...
                                  {/* discount % start */}
                                  {/* discount % end */}
                                  <a href="https://opencart.workdo.io/diamond/index.php?route=product/product&language=en-gb&product_id=44">
                                    <div className="second-image">
                                      <img
                                        src="https://opencart.workdo.io/diamond/image/cache/catalog/product/4/1-1000x1000.png"
                                        title="<b>Best Dill’s </b> Product stores"
                                        alt="<b>Best Dill’s </b> Product stores"
                                        className="img-fluid"
                                      />
                                    ...
                                    <div className="second-image">
                                      <img
                                        src="https://opencart.workdo.io/diamond/image/cache/catalog/product/4/2-1000x1000.png"
                                        title="<b>Best Dill’s </b> Product stores"
                                        alt="<b>Best Dill’s </b> Product stores"
                                        className="img-fluid"
                                      />
...
*/}
                                  ...
                                  <p className="catlist-des">
                                    ...
                                    multiple wireless innovations. An..
                                  </p>
                                  <div className="web_option">
                                    <div className="mb-3 required">
                                      <label className="form-label">Size</label>
                            ...
                            <div className="product-thumb">
                              <div className="product-bg">
                                <div className="image">
                                  ...
                                  {/* discount % start */}
                                  {/* discount % end */}
                                  <a href="https://opencart.workdo.io/diamond/index.php?route=product/product&language=en-gb&product_id=46">
                                    <div className="second-image">
                                      <img
                                        src="https://opencart.workdo.io/diamond/image/cache/catalog/product/14/1-1000x1000.png"
                                        title="<b>Best Dill’s </b> Product stores"
                                        alt="<b>Best Dill’s </b> Product stores"
                                        className="img-fluid"
                                      />
                                    ...
                                    <div className="second-image">
                                      <img
                                        src="https://opencart.workdo.io/diamond/image/cache/catalog/product/14/2-1000x1000.png"
                                        title="<b>Best Dill’s </b> Product stores"
                                        alt="<b>Best Dill’s </b> Product stores"
                                        className="img-fluid"
                                      />
                                ...
                                <div className="product-caption">
                                  <div className="bran">
                                    <span>
                                      <a
                                        href="https://opencart.workdo.io/diamond/index.php?route=product/manufacturer|info&manufacturer_id=10"
                                        className="textdeb"
                                      >
                                        fashion
                                      </a>
...
*/}
                                  ...
                                  <p className="catlist-des">
                                    ...
                                    into the newest VAIO notebooks lies Intel's
                                    latest, most powerful innovation yet: Intel®
                                    Centrino® 2 processor tech..
                                  </p>
                                  <div className="web_option">
                                    <div className="mb-3 required">
                                      <label className="form-label">Size</label>
                            ...
                            <div className="product-thumb">
                              <div className="product-bg">
                                <div className="image">
                                  ...
                                  {/* discount % start */}
                                  {/* discount % end */}
                                  <a href="https://opencart.workdo.io/diamond/index.php?route=product/product&language=en-gb&product_id=42">
                                    <div className="second-image">
                                      <img
                                        src="https://opencart.workdo.io/diamond/image/cache/catalog/product/2/1-1000x1000.png"
                                        title="<b>Best Dill’s </b> Product stores"
                                        alt="<b>Best Dill’s </b> Product stores"
                                        className="img-fluid"
                                      />
                                    ...
                                    <div className="second-image">
                                      <img
                                        src="https://opencart.workdo.io/diamond/image/cache/catalog/product/2/2-1000x1000.png"
                                        title="<b>Best Dill’s </b> Product stores"
                                        alt="<b>Best Dill’s </b> Product stores"
                                        className="img-fluid"
                                      />
                              ...
                              <div className="product-bg">
                                <div className="image">
                                  ...
                                  <a href="https://opencart.workdo.io/diamond/index.php?route=product/product&language=en-gb&product_id=30">
                                    <div className="second-image">
                                      <img
                                        src="https://opencart.workdo.io/diamond/image/cache/catalog/product/11/1-1000x1000.png"
                                        title="<b>Best Dill’s </b> Product stores"
                                        alt="<b>Best Dill’s </b> Product stores"
                                        className="img-fluid"
                                      />
                                    ...
                                    <div className="second-image">
                                      <img
                                        src="https://opencart.workdo.io/diamond/image/cache/catalog/product/11/2-1000x1000.png"
                                        title="<b>Best Dill’s </b> Product stores"
                                        alt="<b>Best Dill’s </b> Product stores"
                                        className="img-fluid"
                                      />
                                ...
                                <div className="product-caption">
                                  <div className="bran">
                                    <span>
                                      <a
                                        href="https://opencart.workdo.io/diamond/index.php?route=product/manufacturer|info&manufacturer_id=9"
                                        className="textdeb"
                                      >
                                        cloths
                                      </a>
                            ...
                            <div className="product-thumb">
                              <div className="product-bg">
                                <div className="image">
                                  ...
                                  {/* discount % start */}
                                  {/* discount % end */}
                                  <a href="https://opencart.workdo.io/diamond/index.php?route=product/product&language=en-gb&product_id=51">
                                    <div className="second-image">
                                      <img
                                        src="https://opencart.workdo.io/diamond/image/cache/catalog/product/8/1-1000x1000.png"
                                        title="<b>Best Dill’s </b> Product stores"
                                        alt="<b>Best Dill’s </b> Product stores"
                                        className="img-fluid"
                                      />
                                    ...
                                    <div className="second-image">
                                      <img
                                        src="https://opencart.workdo.io/diamond/image/cache/catalog/product/8/2-1000x1000.png"
                                        title="<b>Best Dill’s </b> Product stores"
                                        alt="<b>Best Dill’s </b> Product stores"
                                        className="img-fluid"
                                      />
                                ...
                                <div className="product-caption">
                                  ...
                                  <h4 className="protitle">
                                    <a href="https://opencart.workdo.io/diamond/index.php?route=product/product&language=en-gb&product_id=51">
                                      Sports Fashion Shoes Men Sport Shoes
                                    </a>
                                  </h4>
                                </div>
                                <div className="caption">
...
*/}
                                  ...
                                  <p className="catlist-des">
                                    ...
                                    that it 'defines (a) new D-SLR category',
                                    while we're not typically too concerned with
                                    marketing talk this particular statement is
                                    clearly pretty accurate...
                                  </p>
                                  <div className="web_option">
                                    <div className="mb-3 required">
                                      <label className="form-label">Size</label>
                            ...
                            <div className="product-thumb">
                              <div className="product-bg">
                                <div className="image">
                                  ...
                                  {/* discount % start */}
                                  {/* discount % end */}
                                  <a href="https://opencart.workdo.io/diamond/index.php?route=product/product&language=en-gb&product_id=52">
                                    <div className="second-image">
                                      <img
                                        src="https://opencart.workdo.io/diamond/image/cache/catalog/product/3/1-1000x1000.png"
                                        title="<b>Best Dill’s </b> Product stores"
                                        alt="<b>Best Dill’s </b> Product stores"
                                        className="img-fluid"
                                      />
                                    ...
                                    <div className="second-image">
                                      <img
                                        src="https://opencart.workdo.io/diamond/image/cache/catalog/product/3/2-1000x1000.png"
                                        title="<b>Best Dill’s </b> Product stores"
                                        alt="<b>Best Dill’s </b> Product stores"
                                        className="img-fluid"
                                      />
...
*/}
                                  ...
                                  {/* discount % end */}
                                  <div className="price">
                                    <span className="price-new">$2.00</span>
                                  </div>
                                  <p className="catlist-des">
                                    HTC Touch - in High Definition. Watch music
                                    videos and streaming content in
                                    awe-inspiring high definition clarity for a
                                    mobile experience you never thought
                                    possible. Seductively sleek, the HTC Touch
                                    H..
                                  </p>
                                  <div className="web_option">
                                    <div className="mb-3 required">
                            ...
                            <div className="product-thumb">
                              <div className="product-bg">
                                <div className="image">
                                  ...
                                  {/* discount % start */}
                                  {/* discount % end */}
                                  <a href="https://opencart.workdo.io/diamond/index.php?route=product/product&language=en-gb&product_id=53">
                                    <div className="second-image">
                                      <img
                                        src="https://opencart.workdo.io/diamond/image/cache/catalog/product/9/1-1000x1000.png"
                                        title="<b>Best Dill’s </b> Product stores"
                                        alt="<b>Best Dill’s </b> Product stores"
                                        className="img-fluid"
                                      />
                                    ...
                                    <div className="second-image">
                                      <img
                                        src="https://opencart.workdo.io/diamond/image/cache/catalog/product/9/2-1000x1000.png"
                                        title="<b>Best Dill’s </b> Product stores"
                                        alt="<b>Best Dill’s </b> Product stores"
                                        className="img-fluid"
                                      />
                                ...
                                <div className="product-caption">
                                  ...
                                  <h4 className="protitle">
                                    <a href="https://opencart.workdo.io/diamond/index.php?route=product/product&language=en-gb&product_id=53">
                                      unique design diamond necklace
                                    </a>
                                  </h4>
                                </div>
                                <div className="caption">
                            ...
                            <div className="product-thumb">
                              <div className="product-bg">
                                <div className="image">
                                  ...
                                  {/* discount % start */}
                                  {/* discount % end */}
                                  <a href="https://opencart.workdo.io/diamond/index.php?route=product/product&language=en-gb&product_id=54">
                                    <div className="second-image">
                                      <img
                                        src="https://opencart.workdo.io/diamond/image/cache/catalog/product/6/1-1000x1000.png"
                                        title="<b>Best Dill’s </b> Product stores"
                                        alt="<b>Best Dill’s </b> Product stores"
                                        className="img-fluid"
                                      />
                                    ...
                                    <div className="second-image">
                                      <img
                                        src="https://opencart.workdo.io/diamond/image/cache/catalog/product/6/2-1000x1000.png"
                                        title="<b>Best Dill’s </b> Product stores"
                                        alt="<b>Best Dill’s </b> Product stores"
                                        className="img-fluid"
                                      />
                ...
                <div className="container">
                  <div className="row">
                    ...
                    <div className="col-sm-12">
                      <div className="wdlogoslider">
                        <div className="logoimg">
                          <a href="#">
                            <img
                              src="https://opencart.workdo.io/diamond/image/cache/catalog/brand-logo/1-172x41.png"
                              alt="brand"
                              className="mx-auto img-fluid"
                            />
                          </a>
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6 col-xs-12">
                      <div className="wdcategory">
                        <div className="wd-item-layout">
                          <div className="wd-item-img">
                            <a href="https://opencart.workdo.io/diamond/index.php?route=product/category&path=57">
                              <img
                                src="https://opencart.workdo.io/diamond/image/cache/catalog/category/1-270x335.jpg"
                                alt="bracelet"
                                title="bracelet"
                                className="img-fluid"
                              />
                          ...
                          <h4 className="wd-item-title">
                            ...
                            <div className="wd-item-caption">
                              <a
                                href="https://opencart.workdo.io/diamond/index.php?route=product/category&path=57"
                        ...
                        <div className="wd-item-layout">
                          <div className="wd-item-img">
                            <a href="https://opencart.workdo.io/diamond/index.php?route=product/category&path=25">
                              <img
                                src="https://opencart.workdo.io/diamond/image/cache/catalog/category/2-270x335.jpg"
                                alt="necklace"
                                title="necklace"
                                className="img-fluid"
                              />
                          ...
                          <h4 className="wd-item-title">
                            ...
                            <div className="wd-item-caption">
                              <a
                                href="https://opencart.workdo.io/diamond/index.php?route=product/category&path=25"
                                className="btn btn-primary"
                              >
                                <span>Go to categories</span>
                                <img
                        ...
                        <div className="wd-item-layout">
                          <div className="wd-item-img">
                            <a href="https://opencart.workdo.io/diamond/index.php?route=product/category&path=20">
                              <img
                                src="https://opencart.workdo.io/diamond/image/cache/catalog/category/3-270x335.jpg"
                                alt="ring"
                                title="ring"
                                className="img-fluid"
                              />
                          ...
                          <h4 className="wd-item-title">
                            ...
                            <div className="wd-item-caption">
                              <a
                                href="https://opencart.workdo.io/diamond/index.php?route=product/category&path=20"
                                className="btn btn-primary"
                              >
                                <span>Go to categories</span>
                                <img
                        ...
                        <div className="wd-item-layout">
                          <div className="wd-item-img">
                            <a href="https://opencart.workdo.io/diamond/index.php?route=product/category&path=17">
                              <img
                                src="https://opencart.workdo.io/diamond/image/cache/catalog/category/4-270x335.jpg"
                                alt="bead"
                                title="bead"
                                className="img-fluid"
                              />
                          ...
                          <h4 className="wd-item-title">
                            ...
                            <div className="wd-item-caption">
                              <a
                                href="https://opencart.workdo.io/diamond/index.php?route=product/category&path=17"
                                className="btn btn-primary"
                              >
                                <span>Go to categories</span>
                                <img
                    ...
                    <div className="row">
                      <div className="col-xs-12 testi">
                        <div className="wbtesti">
                          <div className="testi-spc">
                            <div className="item">
                              <div className="testi-img">
                                <img
                                  alt={1}
                                  className="img-fluid"
                                  src="image/catalog/testimonial/1.png"
                                />
                              </div>
                            ...
                            <div className="item">
                              <div className="testi-img">
                                <img
                                  alt={1}
                                  className="img-fluid"
                                  src="image/catalog/testimonial/2.png"
                                />
                              </div>
                              <div className="testi-dec">
                                <h4>Excellent</h4>
                            ...
                            <div className="blogshadow blog-thumbnail">
                              <div className="blog-left">
                                <div className="workdo-blog-image">
                                  <img
                                    src="https://opencart.workdo.io/diamond/image/cache/catalog/blog/5-1000x670.jpg"
                                    alt="Blog & Articles"
                                    title="Blog & Articles"
                                    className="img-fluid"
                                  />
                              ...
                              <div className="blog-right">
                                <h4>
                                  <a href="https://opencart.workdo.io/diamond/index.php?route=extension/blogger/information/blogger&blogger_id=5">
                                    Best bracelet and necklaces
                                  </a>{" "}
                                </h4>
                                ...
                                <div className="blog-date blog-bottom">
                                  <div className="read_link">
                                    <a
                                      ...
                                      href="https://opencart.workdo.io/diamond/index.php?route=extension/blogger/information/blogger&blogger_id=5"
                                    >
                                      read more
                                    </a>
                                  </div>
                          ...
                          <div className="product-block  cless">
                            <div className="blogshadow blog-thumbnail">
                              <div className="blog-left">
                                <div className="workdo-blog-image">
                                  <img
                                    src="https://opencart.workdo.io/diamond/image/cache/catalog/blog/4-1000x670.jpg"
                                    alt="Blog & Articles"
                                    title="Blog & Articles"
                                    className="img-fluid"
                                  />
                              ...
                              <div className="blog-right">
                                <h4>
                                  <a href="https://opencart.workdo.io/diamond/index.php?route=extension/blogger/information/blogger&blogger_id=4">
                                    Best bracelet and necklaces
                                  </a>{" "}
                                </h4>
                                <div className="workdo-post-author"></div>
                                ...
                                <div className="blog-date blog-bottom">
                                  <div className="read_link">
                                    <a
                                      className="btn btn-primary read_more"
                                      href="https://opencart.workdo.io/diamond/index.php?route=extension/blogger/information/blogger&blogger_id=4"
                                    >
                                      read more
                                    </a>
                                  </div>
                          ...
                          <div className="product-block  cless">
                            <div className="blogshadow blog-thumbnail">
                              <div className="blog-left">
                                <div className="workdo-blog-image">
                                  <img
                                    src="https://opencart.workdo.io/diamond/image/cache/catalog/blog/3-1000x670.jpg"
                                    alt="Blog & Articles"
                                    title="Blog & Articles"
                                    className="img-fluid"
                                  />
                              ...
                              <div className="blog-right">
                                <h4>
                                  <a href="https://opencart.workdo.io/diamond/index.php?route=extension/blogger/information/blogger&blogger_id=3">
                                    Best bracelet and necklaces
                                  </a>{" "}
                                </h4>
                                <div className="workdo-post-author"></div>
                                ...
                                <div className="blog-date blog-bottom">
                                  <div className="read_link">
                                    <a
                                      className="btn btn-primary read_more"
                                      href="https://opencart.workdo.io/diamond/index.php?route=extension/blogger/information/blogger&blogger_id=3"
                                    >
                                      read more
                                    </a>
                                  </div>
                          ...
                          <div className="product-block  cless">
                            <div className="blogshadow blog-thumbnail">
                              <div className="blog-left">
                                <div className="workdo-blog-image">
                                  <img
                                    src="https://opencart.workdo.io/diamond/image/cache/catalog/blog/2-1000x670.jpg"
                                    alt="Blog & Articles"
                                    title="Blog & Articles"
                                    className="img-fluid"
                                  />
                              ...
                              <div className="blog-right">
                                <h4>
                                  <a href="https://opencart.workdo.io/diamond/index.php?route=extension/blogger/information/blogger&blogger_id=2">
                                    Best bracelet and necklaces
                                  </a>{" "}
                                </h4>
                                <div className="workdo-post-author"></div>
                                ...
                                <div className="blog-date blog-bottom">
                                  <div className="read_link">
                                    <a
                                      className="btn btn-primary read_more"
                                      href="https://opencart.workdo.io/diamond/index.php?route=extension/blogger/information/blogger&blogger_id=2"
                                    >
                                      read more
                                    </a>
                                  </div>
                          ...
                          <div className="product-block  cless">
                            <div className="blogshadow blog-thumbnail">
                              <div className="blog-left">
                                <div className="workdo-blog-image">
                                  <img
                                    src="https://opencart.workdo.io/diamond/image/cache/catalog/blog/1-1000x670.jpg"
                                    alt="Blog & Articles"
                                    title="Blog & Articles"
                                    className="img-fluid"
                                  />
                              ...
                              <div className="blog-right">
                                <h4>
                                  <a href="https://opencart.workdo.io/diamond/index.php?route=extension/blogger/information/blogger&blogger_id=1">
                                    Best bracelet and necklaces
                                  </a>{" "}
                                </h4>
                                <div className="workdo-post-author"></div>
                                ...
                                <div className="blog-date blog-bottom">
                                  <div className="read_link">
                                    <a
                                      className="btn btn-primary read_more"
                                      href="https://opencart.workdo.io/diamond/index.php?route=extension/blogger/information/blogger&blogger_id=1"
                                    >
                                      read more
                                    </a>
                                  </div>
                    ...
                    <div className="row">
                      ...
                      <div className="offer_bnr">
                        <div className="beffect">
                          <a href="#">
                            <img
                              src="https://opencart.workdo.io/diamond/image/cache/catalog/offerbanner/1-260x260.jpg"
                              alt="offerbanner"
                              className="mx-auto img-fluid"
                            />
                          </a>
                        ...
                        <div className="beffect">
                          <a href="#">
                            <img
                              src="https://opencart.workdo.io/diamond/image/cache/catalog/offerbanner/2-260x260.jpg"
                              alt="offerbanner"
                              className="mx-auto img-fluid"
                            />
                          </a>
                        ...
                        <div className="beffect">
                          <a href="#">
                            <img
                              src="https://opencart.workdo.io/diamond/image/cache/catalog/offerbanner/3-260x260.jpg"
                              alt="offerbanner"
                              className="mx-auto img-fluid"
                            />
                          </a>
                        ...
                        <div className="beffect">
                          <a href="#">
                            <img
                              src="https://opencart.workdo.io/diamond/image/cache/catalog/offerbanner/4-260x260.jpg"
                              alt="offerbanner"
                              className="mx-auto img-fluid"
                            />
                          </a>
                        ...
                        <div className="beffect">
                          <a href="#">
                            <img
                              src="https://opencart.workdo.io/diamond/image/cache/catalog/offerbanner/5-260x260.jpg"
                              alt="offerbanner"
                              className="mx-auto img-fluid"
                            />
                          </a>
                        ...
                        <div className="beffect">
                          <a href="#">
                            <img
                              src="https://opencart.workdo.io/diamond/image/cache/catalog/offerbanner/6-260x260.jpg"
                              alt="offerbanner"
                              className="mx-auto img-fluid"
                            />
                          </a>
