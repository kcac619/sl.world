...
const PairSearchResults = () => {
  ...
  useEffect(() => {
    ...
    if (Storefilters.hasOwnProperty(keyToLoad)) {
      ...
      fetchSolitaires(Storefilters[keyToLoad],currentPage)
    } else {
      setSelectedFilters({});
    }
  }, [Storefilters]);

  const fetchSolitaires = async (filters,pageNumber = currentPage) => {
...
C409.699,390.129,410.355,381.902,407.164,374.717z"
      ...
      <h1
        ...
        <div className="row panel-default workdo_blog_page rless" style={{ overflowY: "auto" }}>
